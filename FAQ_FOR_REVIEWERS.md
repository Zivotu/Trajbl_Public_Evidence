...
**A:** While the initial high-quality retention (95%+) was measured on Croatian medical/business data, tests on English LongBench-E datasets confirm a similar relative performance gain (+0.167 SQuAD F1) over baseline token-pruning solutions (LLMLingua-2), demonstrating generalization across languages.
